 ...
 */
public class LoansPanel extends JPanel implements Refreshable {

    private final Database db;
    private final ScreenNavigator nav;

    private final JComboBox<User> cbUser = new JComboBox<>();
    ...
    private List<Loan> currentLoans = List.of();
    private final DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    public LoansPanel(Database db, ScreenNavigator nav) {
        this.db = db;
        this.nav = nav;
        buildUI();
        onShow();
    ...
    private void buildUI() {
        ...
        JButton btVoltar = new JButton("Voltar ao dashboard");
        btVoltar.addActionListener(e -> nav.showScreen("dashboard"));
